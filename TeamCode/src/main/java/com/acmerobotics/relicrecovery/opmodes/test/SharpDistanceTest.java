...
public class SharpDistanceTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            telemetry.addData("redDistance", proximitySensor.getDistance(AllianceColor.RED, DistanceUnit.CM));
            telemetry.addData("blueDistance", proximitySensor.getDistance(AllianceColor.BLUE, DistanceUnit.CM));
            telemetry.update();
        }
    }
}
