...
public class DriveConstants {
    ...
    public static PIDFCoefficients HEADING_COEFFS = new PIDFCoefficients(0, 0, 0, 0.234, 0);
    public static PIDFCoefficients AXIAL_COEFFS = new PIDFCoefficients(0, 0, 0, 0.0185, 0);
    public static PIDFCoefficients LATERAL_COEFFS = new PIDFCoefficients(0, 0, 0, 0.0183, 0);
