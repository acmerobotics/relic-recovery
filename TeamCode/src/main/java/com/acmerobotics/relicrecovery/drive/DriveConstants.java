...
public class DriveConstants {
    ...
    public static MotionConstraints POINT_TURN_CONSTRAINTS = new MotionConstraints(0.5, 2.0, 4.0, MotionConstraints.EndBehavior.VIOLATE_MAX_ABS_V);

    public static PIDFCoefficients HEADING_COEFFS = new PIDFCoefficients(-0.02, 0, 0, 0.03, 0);
    public static PIDFCoefficients AXIAL_COEFFS = new PIDFCoefficients(0, 0, 0, 0.015, 0);
