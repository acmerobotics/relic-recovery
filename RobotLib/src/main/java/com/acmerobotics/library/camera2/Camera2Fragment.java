...
package com.acmerobotics.library.camera2;
...
public class Camera2Fragment extends Fragment
    ...
    @SuppressLint("ValidFragment")
    private Camera2Fragment(ImageReader.OnImageAvailableListener imageListener, @LayoutRes int layout) {
    ...
    public static Camera2Fragment newInstance(OnImageAvailableListener imageListener, @LayoutRes int layout) {
        return new Camera2Fragment(imageListener, layout);
    }
